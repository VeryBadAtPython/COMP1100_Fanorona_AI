...
{-|
Module      : Dragons.Fanorona.Codeworld
Description : CodeWorld interface for the Fanorona game
...
data UIModel
  ...
  | MovePiece Location Bool
    -- ^ Player needs to choose a square to move to, or perhaps may pass.
  | CompleteMove Location Location
    -- ^ Player may need to specify whether to approach or withdraw.
  deriving (Eq, Show)
